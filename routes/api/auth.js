                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #ff0000; border-radius: 5px; text-align: center;"> 
                                                                                            <a href="http://101.50.3.61:3000/forgot/password/${user_session.code}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #ff0000; border: solid 1px #ff0000; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #ff0000;">
                                                                                                Change New Password
                                                                                            </a>
                                                                                        </td>
                                                                                    </tr>
